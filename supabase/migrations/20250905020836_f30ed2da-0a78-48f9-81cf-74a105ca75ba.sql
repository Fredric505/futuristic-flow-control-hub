-- Create all necessary RLS policies with correct column references

-- Profiles table policies (uses 'id' as user identifier)
...
-- Processes table policies (uses 'user_id')
...
-- Messages table policies (uses 'user_id')
...
-- System settings policies (admin only - no user column)
